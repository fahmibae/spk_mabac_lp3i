        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body"><a href="<?= site_url('admin/user/create'); ?>" class="btn btn-primary my-4 ">Input Peserta</a>
                ...
                <div class="table-responsive">
                  <table class="table">
                   ...
                   echo "<td align='center'>
                          <a href='".site_url('admin/user/view_edit/'.$user->id_user)."' class='btn btn-success btn-xs'><i class='fa fa-pencil-alt'></i></a>
                        </td>";
                         }elseif($user->level == "user") {
                    echo "<td align='center'>
                          <a href='".site_url('admin/user/view_edit/'.$user->id_user)."' class='btn btn-success btn-xs'><i class='fa fa-pencil-alt'></i></a>
                          <a href='".site_url('admin/user/delete/'.$user->id_user)."' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i></a>
                        </td>";
                         } ?>
                      </tr>
                     <?php $no++; } }?>
          ...
          <div class="col-md-12" style="text-align: center;">
            <a href="#" class="btn btn-warning col-md-11" style="text-align: center; border-radius: 10px; font-size: 15px;">Total Record: <?= $jumlah_user; ?></a>
          </div>
        </div>
            </div>
          </div>
